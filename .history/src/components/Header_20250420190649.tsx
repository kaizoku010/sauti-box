  ...
  return (
    <header className="flex items-center justify-between px-6 py-4 bg-gray-800 text-white">
      ...
      <div className="flex items-center space-x-3">
        <Link href="/subscribe" className="px-4 py-1 bg-gradient-to-r from-primary to-accent rounded-full text-sm font-medium hidden sm:block">
          Subscribe
        </Link>
        ...
        {isLoggedIn ? (
          ...
          <div className="flex items-center space-x-2">
            <div className="dropdown dropdown-end">
              <button className="px-3 py-1.5 bg-gray-700 hover:bg-gray-600 rounded-md text-sm font-medium flex items-center">
            ...
            <div className="dropdown dropdown-end">
              <button className="px-3 py-1.5 bg-primary hover:bg-blue-600 rounded-md text-sm font-medium flex items-center">
