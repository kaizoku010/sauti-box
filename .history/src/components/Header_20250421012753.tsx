...
const Header = () => {
  ...
  return (
    <header className="flex items-center justify-between px-4 sm:px-6 md:px-8 py-4 glass-effect text-white rounded-[30px] mx-6 my-5 z-10">
        ...
        {isLoggedIn ? (
          ...
          <div className="flex items-center space-x-2">
            <div className="dropdown dropdown-end">
              ...
              <div className="dropdown-content hidden group-hover:block absolute right-0 mt-2 w-48 glass-effect rounded-xl shadow-lg z-50 overflow-hidden">
