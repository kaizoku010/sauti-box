...
import TestVideo from "../images/test-video.mp4"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="hidden md:block">
            ...
            >
              ...
              <div className="absolute -bottom-4 -right-4 bg-black/80 backdrop-blur-md p-4 rounded-lg shadow-lg z-20 transition-transform duration-500 space-y-3">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-white font-bold">
                      {currentAlbum.stats.purchases.toLocaleString()}
                    </p>
                  </div>
                  <div className="h-8 w-[1px] bg-gray-700"></div>
                  <div>
                    ...
                    <p className="text-white font-bold">
                      {currentAlbum.stats.streams.toLocaleString()}
                    </p>
                  </div>
                </div>
                <div className="flex space-x-2">
                  <div className="px-2 py-1 bg-primary/20 rounded-full">
                    <p className="text-xs text-primary">
                      {currentAlbum.stats.streams > 1000000 ? '🔥 Trending' : '📈 Rising'}
                    </p>
                  </div>
                  <div className="px-2 py-1 bg-green-500/20 rounded-full">
                    <p className="text-xs text-green-500">
                      {currentAlbum.stats.purchases > 50000 ? '💎 Platinum' : '🥇 Gold'}
                    </p>
                  </div>
                </div>
              </div>
