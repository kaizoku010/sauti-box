    ...
    <div
      className={`fixed z-50 transition-all duration-300 ease-in-out
        ${isMinimized
          ...
          : 'bottom-6 mx-auto h-24 rounded-xl left-1/2 transform -translate-x-1/2 max-w-[100%]'}
      ...
      {isMinimized ? (
        ...
        <div className="flex items-center h-full px-3">
          <div className="w-10 h-10 rounded-full overflow-hidden mr-3 flex-shrink-0">
            <img
              src={currentSong.coverImage || Vinka.src}
        ...
        <div id='sleek' className="flex items-center justify-between h-full px-6">
          <div className="flex items-center w-1/4">
            <div className="rounded-lg overflow-hidden mr-4 flex-shrink-0">
              <img
                src={currentSong.coverImage || Vinka.src}
                alt={currentSong.title}
                className="w-full h-full object-cover"
