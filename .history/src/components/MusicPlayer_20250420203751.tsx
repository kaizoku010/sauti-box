    ...
    <div
      className={`fixed z-50 transition-all duration-300 ease-in-out
        ${isMinimized
          ...
          : 'bottom-6 left-[5rem] right-6 max-w-[calc(100%-6rem)] h-24 rounded-xl mx-auto'}
        backdrop-filter backdrop-blur-xl bg-black/40 border border-gray-800 shadow-lg`}
    >
      {isMinimized ? (
        // Mini Player
        <div className="flex items-center h-full px-3">
          ...
          <div className="flex items-center space-x-2">
            <button
              onClick={togglePlay}
              className="w-8 h-8 rounded-full border border-primary flex items-center justify-center text-primary hover:bg-primary/10"
            >
        ...
        <div className="flex items-center h-full px-6">
          ...
          <div className="flex-1 max-w-xl">
            <div className="flex items-center justify-center space-x-4 mb-2">
              ...
              <button
                onClick={togglePlay}
                className="w-10 h-10 rounded-full border border-primary flex items-center justify-center text-primary hover:bg-primary/10"
              >
