...
import { FiSearch, FiBell, FiUser, FiShoppingCart, FiLogIn, FiUserPlus, FiX, FiMenu } from 'react-icons/fi';
      ...
      <div className="flex items-center space-x-5">
        ...
        {isMobile && (
          <button
            ...
            className="p-2 rounded-full hover:bg-gray-800/40 text-primary-89"
          >
            <FiMenu size={20} />
          </button>
        )}
        ...
        {isLoggedIn ? (
          ...
          <div id='hide_me' className="flex items-center space-x-3">
            <Link href="/login">
