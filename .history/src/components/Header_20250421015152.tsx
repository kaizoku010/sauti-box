        ...
        {isLoggedIn ? (
          ...
          <div className="flex items-center space-x-2">
            <div className="dropdown dropdown-end group">
              <button id='curved' className="px-3 py-1.5 border border-primary-89 text-primary-89 bg-transparent hover:bg-black/20 rounded-full text-sm font-medium flex items-center backdrop-blur-sm">
