...
const Header = () => {
  ...
  return (
    <header className="flex items-center justify-between px-4 sm:px-6 md:px-8 py-4 glass-effect text-white rounded-xl mx-4 mt-4 z-10">
      <div className="flex-1">
        <div className="relative">
          <input
            type="text"
            placeholder="Search for artists, songs, albums..."
            className="w-full max-w-md px-2 sm:px-4 py-2 pl-8 sm:pl-10 bg-gray-800/50 backdrop-blur-sm rounded-full text-white focus:outline-none focus:ring-2 focus:ring-primary border border-gray-700 text-sm sm:text-base"
          />
