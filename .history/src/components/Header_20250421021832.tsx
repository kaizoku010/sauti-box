...
const Header = () => {
  ...
  return (
    <header className="flex items-center justify-between px-8 sm:px-8 md:px-8 py-3 glass-effect text-white rounded-[30px] w-full backdrop-blur-xl" style={{ paddingLeft: '2rem', paddingRight: '2rem' }}>
