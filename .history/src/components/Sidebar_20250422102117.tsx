...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, setIsOpen }) => {
  ...
  return (
    <>
      ...
      <div className={`fixed left-0 top-0 h-screen ${isMobile ? (isOpen ? 'w-64' : 'w-0') : 'w-16'} flex flex-col bg-background text-white shadow-lg transition-all duration-300 z-40 ${isMobile && !isOpen ? '-translate-x-full' : 'translate-x-0'} overflow-hidden`}>
