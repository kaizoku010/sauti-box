...
const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative h-[70vh] mb-16 overflow-hidden w-full max-w-full">
      ...
      <div className="relative h-full max-w-6xl mx-auto px-6 flex items-center">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="hidden md:block">
            ...
            >
              <div 
              className="absolute inset-0 bg-gradient-to-br from-primary/20 to-purple-500/20 rounded-lg transform rotate-6 scale-105" />
              <img
                src={currentAlbum.coverImage}
                alt={currentAlbum.title}
                id='hero-album-art'
                className="relative z-10 w-full h-auto rounded-lg shadow-2xl transform rotate-3 hover:rotate-0 transition-transform duration-500 object-cover"
      ...
      <div className="absolute bottom-8 left-0 right-0 flex justify-left space-x-2">
