...
const Header = () => {
  ...
  return (
    <header className="flex items-center justify-between px-2 sm:px-4 md:px-6 py-4 bg-gray-900 text-white">
      <div className="flex-1">
        <div className="relative">
          <input
            type="text"
            placeholder="Search for artists, songs, albums..."
            className="w-full max-w-md px-2 sm:px-4 py-2 pl-8 sm:pl-10 bg-gray-800 rounded-full text-white focus:outline-none focus:ring-2 focus:ring-primary border border-gray-700 text-sm sm:text-base"
          />
        ...
        {isLoggedIn ? (
          <>
            ...
            <Link href="/profile" className="flex items-center space-x-2">
              ...
              <span className="font-medium text-sm hidden md:block">kalanzi Dixon</span>
            </Link>
          </>
        ) : (
          <div className="flex items-center space-x-2">
            <div className="dropdown dropdown-end">
              <button id='curved' className="px-3 py-1.5 border border-gray-700 text-gray-300 hover:border-primary hover:text-primary rounded-md text-sm font-medium flex items-center">
            ...
            <div className="dropdown dropdown-end">
              <button id='curved' className="px-3 py-1.5 border border-primary text-primary hover:bg-primary/10 rounded-md text-sm font-medium flex items-center">
