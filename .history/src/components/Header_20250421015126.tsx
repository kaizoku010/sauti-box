          ...
          {isSearchOpen ? (
            <div className="relative flex items-center">
              <input
                ...
                className="w-64 px-4 py-2 pl-10 bg-gray-800/40 backdrop-blur-sm rounded-full text-white focus:outline-none focus:ring-2 focus:ring-primary border border-gray-700/50 text-sm"
              />
            ...
            <button
              ...
              className="p-2 rounded-full hover:bg-gray-800/40 text-gray-300 hover:text-primary transition-colors"
            >
              <FiSearch size={20} />
            </button>
          )}
