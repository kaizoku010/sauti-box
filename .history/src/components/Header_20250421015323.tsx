          ...
          <div className="flex items-center space-x-2">
            <div className="dropdown dropdown-end group">
              ...
              <div className="dropdown-content hidden group-hover:block absolute right-0 mt-2 w-48 glass-effect rounded-[20px] shadow-lg z-50 overflow-hidden">
                <Link href="/login" className="block px-4 py-2 hover:bg-primary/10 hover:text-primary-89 transition-colors">
                  <FiUser className="inline mr-2" size={16} />
                  User Login
                </Link>
                <Link href="/artist/login" className="block px-4 py-2 hover:bg-primary/10 hover:text-primary-89 transition-colors">
