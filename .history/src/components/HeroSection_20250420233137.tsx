...
const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative h-[70vh] mb-20 overflow-hidden w-full max-w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="hidden md:block">
            ...
            >
              <div
                      id='pp-div'
              className="absolute inset-0 bg-gradient-to-br from-primary/20 to-purple-500/20 rounded-lg transform scale-105" />
              <img
      ...
      <div className="absolute -bottom-12 left-0 right-0 flex justify-center space-x-2 py-2">
