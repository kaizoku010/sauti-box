        ...
        {isLoggedIn ? (
          ...
          <div className="flex items-center space-x-2">
            <div className="dropdown dropdown-end">
              <button className="px-3 py-1.5 border border-gray-700 text-gray-300 hover:border-primary hover:text-primary rounded-md text-sm font-medium flex items-center">
