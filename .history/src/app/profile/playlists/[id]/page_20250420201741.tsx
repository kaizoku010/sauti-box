        ...
        <div className="flex flex-col md:flex-row items-start gap-8 mb-8">
          ...
          <div className="flex-1">
            ...
            <div className="flex space-x-3">
              ...
              <button
                className="px-4 py-2 border-2 border-gray-700 text-gray-300 rounded-md hover:border-primary hover:text-primary flex items-center"
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-75">
            <div className="relative w-full max-w-2xl bg-gray-800 rounded-lg shadow-xl p-6">
                    ...
                    <tbody>
                      {availableSongs.map((song) => (
                        <tr key={song._id} className="border-b border-gray-700 hover:bg-gray-700/50">
                          ...
                          <td className="py-3 px-4 text-right">
                            <button
                              className="px-3 py-1 border-2 border-primary text-primary rounded hover:bg-primary/10"
              ...
              <div className="flex justify-end mt-6">
                <button
                  className="px-4 py-2 border-2 border-gray-700 text-gray-300 rounded-md hover:border-primary hover:text-primary"
                  onClick={() => setIsAddSongModalOpen(false)}
                >
                  Close
                </button>
