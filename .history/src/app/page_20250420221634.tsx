...
export default function Home() {
  return (
    <MainLayout>
      {/* Hero Section */}
      <HeroSection />
      {/* CAROUSEL SECTION: Most Streamed Music */}
      <Carousel title="Most Streamed Music" viewAllLink="/charts">
        {mostStreamedMusic.map((item) => (
      ...
      {/* CAROUSEL SECTION: Most Purchased Music */}
      <Carousel title="Most Purchased Music" viewAllLink="/charts">
        {mostPurchasedMusic.map((item) => (
          <div key={item.id} className="flex-shrink-0 w-56 md:w-64">
            <MusicCard
              id={item.id}
              title={item.title}
      ...
      {/* CAROUSEL SECTION: New Artists */}
      <Carousel title="New Artists" viewAllLink="/artists">
        {newArtists.map((artist) => (
          <div key={artist.id} className="flex-shrink-0 w-40 md:w-48">
            <ArtistCard
              id={artist.id}
              name={artist.name}
              image={artist.image}
      ...
      <section className="mb-10 border-t border-gray-800 pt-6 mt-6">
        <SectionHeader title="Top Charts" viewAllLink="/charts" />
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-2 sm:gap-4 w-full overflow-visible">
      ...
      <section className="mb-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-6 w-full overflow-visible">
      ...
      <section className="mb-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 sm:gap-4 w-full overflow-visible">
