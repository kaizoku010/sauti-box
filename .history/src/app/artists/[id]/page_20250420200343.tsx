      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative mb-8">
          ...
          <div className="absolute bottom-0 right-0 transform translate-y-1/2 px-8 flex items-center space-x-3">
            ...
            <button className="p-2 rounded-full border-2 border-gray-700 text-gray-400 hover:text-primary hover:border-primary">
              <FiShare2 size={20} />
            </button>
          </div>
        </div>
            ...
            <div className="card p-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <div className="mt-2">
                    <a href="#" className="border-2 border-primary text-primary px-3 py-1 rounded-md hover:bg-primary/10 inline-block">Get Tickets</a>
                  </div>
                </div>
              </div>
            </div>
