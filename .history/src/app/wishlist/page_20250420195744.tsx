      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
          ...
          <div className="mt-4 md:mt-0 flex space-x-3">
            <button
              className={`px-4 py-2 rounded-md ${viewMode === 'grid' ? 'bg-primary text-white' : 'bg-gray-800 text-gray-300'}`}
              onClick={() => setViewMode('grid')}
            >
              Grid View
            </button>
            <button
              className={`px-4 py-2 rounded-md ${viewMode === 'list' ? 'bg-primary text-white' : 'bg-gray-800 text-gray-300'}`}
