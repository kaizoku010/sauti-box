      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
          ...
          <div className="mt-4 md:mt-0 flex space-x-3">
            <button
              className={`px-4 py-2 rounded-md ${viewMode === 'grid' ? 'border-2 border-primary text-primary' : 'border-2 border-gray-700 text-gray-300 hover:border-primary hover:text-primary'}`}
              onClick={() => setViewMode('grid')}
            >
              Grid View
            </button>
            <button
              className={`px-4 py-2 rounded-md ${viewMode === 'list' ? 'border-2 border-primary text-primary' : 'border-2 border-gray-700 text-gray-300 hover:border-primary hover:text-primary'}`}
