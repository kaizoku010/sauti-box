...
const newArtists = [
  {
    id: 'na1',
    name: 'Azawi',
    image: artistPlaceholders.azawi.src,
    followers: 25000
  },
  {
    id: 'na2',
    name: 'Vinka',
    image: artistPlaceholders.vinka.src,
    followers: 22000
  },
  {
    id: 'na3',
    name: 'Fik Fameica',
    image: artistPlaceholders.fik.src,
    followers: 20000
  },
  {
    id: 'na4',
    name: 'Lydia Jazmine',
    image: artistPlaceholders.lydia.src,
    followers: 18000
  },
  {
    id: 'na5',
    name: 'John Blaq',
    image: artistPlaceholders.john.src,
    followers: 15000
  },
  {
    id: 'na6',
    name: 'Karole Kasita',
    image: artistPlaceholders.karole.src,
    followers: 12000
  }
];
  ...
  return (
    <MainLayout>
      ...
      <footer className="text-center py-6 border-t border-gray-800 mt-10">
        <div className="mb-4">
          <h3 className="text-xl font-bold mb-2">SautiBox</h3>
          <p className="text-gray-400 text-smaller" style={{ fontSize: 'smaller' }}>Your Music, Your Rights, Your Revenue</p>
        </div>
        <div className="mb-4">
          <a href="mailto:info@sautibox.com" className="text-primary hover:underline" style={{ fontSize: 'smaller' }}>info@sautibox.com</a>
        </div>
        <div className="flex justify-center space-x-4">
          <button className="btn-primary" style={{ fontSize: 'smaller' }}>Google Play</button>
          <button className="btn-primary" style={{ fontSize: 'smaller' }}>App Store</button>
        </div>
      </footer>
