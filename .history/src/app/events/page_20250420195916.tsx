        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
          ...
          <div className="mt-4 md:mt-0">
            <div className="flex space-x-2">
              <button
                className={`px-4 py-2 rounded-md ${filter === 'all' ? 'bg-primary text-white' : 'bg-gray-800 text-gray-300'}`}
                onClick={() => setFilter('all')}
              >
                All Events
              </button>
              <button
                className={`px-4 py-2 rounded-md ${filter === 'upcoming' ? 'bg-primary text-white' : 'bg-gray-800 text-gray-300'}`}
                onClick={() => setFilter('upcoming')}
              >
                Upcoming
              </button>
              <button
                className={`px-4 py-2 rounded-md ${filter === 'saved' ? 'bg-primary text-white' : 'bg-gray-800 text-gray-300'}`}
            ...
            <div className="md:flex">
              ...
              <div className="p-6 md:w-1/2">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link 
                    href="#" 
                    className="px-4 py-2 bg-primary text-white rounded-md hover:bg-accent flex items-center"
                  >
