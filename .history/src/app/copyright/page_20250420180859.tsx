...
const CopyrightPage = () => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      formData.append('artist', (event.currentTarget as HTMLFormElement).elements.namedItem('artist')?.value as string);
      formData.append('genre', (event.currentTarget as HTMLFormElement).elements.namedItem('genre')?.value as string);
