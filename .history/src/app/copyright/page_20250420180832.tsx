...
const CopyrightPage = () => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      // Add metadata
      formData.append('title', (event.currentTarget as HTMLFormElement).elements.namedItem('title')?.value as string);
      formData.append('artist', event.currentTarget['artist'].value);
      formData.append('genre', event.currentTarget['genre'].value);
