...
import Sheba from "../../images/wn.jpg"
      ...
      <div id='page-content' className="max-w-4xl mx-auto">
        ...
        {cartItems.length === 0 && !isComplete ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            {/* payment plan form */}
            <div id='payment-plan' className="md:col-span-1">
              <div className="card p-6 sticky top-4">
                <h2  className="font-bold mb-4">Order Summary</h2>
                
                <div className="space-y-2 mb-4">
                  <div className="flex justify-between">
                    <span id='desc' className="text-gray-400">Subtotal</span>
                    <span>UGX {getTotalPrice().toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between">
                    <span id='desc' className="text-gray-400">Transaction Fee</span>
                    <span>UGX 0</span>
                  </div>
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <select
                            ...
                            required
                          >
                            <option id="desc" value="mtn">MTN Mobile Money</option>
