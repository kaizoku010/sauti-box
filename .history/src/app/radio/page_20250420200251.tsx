...
const radioStations = [
  ...
  },
  {
    ...
    name: 'Radio One',
    frequency: '90.0 FM',
    logo: '/images/radio/radio-one.jpg',
            ...
            <div className="flex flex-col md:flex-row items-center">
              ...
              <div className="flex-1 mt-4 md:mt-0">
                ...
                <div className="flex items-center mt-4">
                  <button
                    className="w-10 h-10 rounded-full border-2 border-primary flex items-center justify-center text-primary mr-4 hover:bg-primary/10"
