...
import { FiMusic, FiDollarSign, FiRadio, FiUsers, FiBarChart2, FiTrendingUp, FiMap, FiShoppingCart, FiUpload, FiCheck, FiPlay } from 'react-icons/fi';
...
// Song list component that uses the music player hook
const SongList = ({ songs, artistName }: { songs: any[], artistName?: string }) => {
