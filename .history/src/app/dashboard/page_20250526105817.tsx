    ...
    return (
      <MainLayout>
        <div className="max-w-6xl mx-auto mt-8">
          <div id='error-message-banner' className="bg-red-900/30 border border-red-500 text-red-300 px-4 py-3 rounded-md">
            <p>{error}</p>
            <p className="mt-2">
          ...
          <div className="card p-6">
            ...
            <div className="space-y-4">
              {streamStats.topSongs && streamStats.topSongs.length > 0 ? (
                streamStats.topSongs.map((song: TopSong, index: number) => (
