...
import { FiMusic, FiDollarSign, FiRadio, FiUsers, FiBarChart2, FiTrendingUp, FiMap, FiShoppingCart, FiDownload } from 'react-icons/fi';
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
          <div>
            ...
            <p className="text-gray-400">Welcome back, Eddy Kenzo</p>
          </div>
          <div className="mt-4 md:mt-0">
            <button className="btn-primary mr-3">Upload Music</button>
