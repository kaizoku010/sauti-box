  ...
  return (
    <div className="min-h-screen flex bg-background">
      ...
      <div className="hidden md:block md:w-1/2 video-container">
        <iframe
          src="https://player.cloudinary.com/embed/?public_id=069e126e5151f3bcaff40c0d76dd6240&cloud_name=dnko3bvt0&player[muted]=true&player[autoplay]=true&player[loop]=true&player[controls]=false&source[sourceTypes][0]=mp4"
