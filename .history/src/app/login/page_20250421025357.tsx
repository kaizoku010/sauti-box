...
import videoSrc from '../../images/vid.mp4';
      ...
      <div className="hidden md:block md:w-1/2 h-screen relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="text-center p-8">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">SautiBox</h1>
            <p className="text-xl text-white">Your Music, Your Rights, Your Revenue</p>
          </div>
        </div>
      </div>
