...
// Import video path - make sure it's the correct path relative to the public directory
const videoPath = '/videos/vid.mp4';
...
const LoginPage = () => {
  ...
  // Prevent the default layout with header
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen flex bg-background">
      {/* Left side - Video */}
      <div className="hidden md:block md:w-1/2 h-screen relative overflow-hidden bg-black">
        <video
          src={videoPath}
