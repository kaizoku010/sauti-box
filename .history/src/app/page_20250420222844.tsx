...
export default function Home() {
  return (
    <MainLayout>
      ...
      <MultiCarousel title="Most Streamed Music" viewAllLink="/charts">
      ...
      <MultiCarousel title="Most Purchased Music" viewAllLink="/charts">
      ...
      <MultiCarousel title="New Artists" viewAllLink="/artists">
